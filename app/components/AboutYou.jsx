...
export default function AboutYou({
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/70 px-4 backdrop-blur-sm">
      <div className="w-full max-w-sm rounded-xl border border-zinc-800 bg-[#111114] p-4 shadow-2xl">
        {/* HEADER */}
        <div className="mb-4">
        ...
        <div className="mb-3 flex gap-2">
          <div className="flex-1">
            ...
            <input
              ...
              className="w-full rounded-lg border border-zinc-800 bg-[#0c0c0f] px-3 py-2 text-xs text-white outline-none placeholder:text-zinc-600 focus:border-zinc-600"
            />
          </div>
        ...
        <div className="mb-3">
          ...
          <textarea
            ...
            rows={2}
            className="w-full resize-none rounded-lg border border-zinc-800 bg-[#0c0c0f] px-3 py-2 text-xs text-white outline-none placeholder:text-zinc-600 focus:border-zinc-600"
          />
        </div>
